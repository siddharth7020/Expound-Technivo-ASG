            ...
            <div className='border-t border-gray-300'>
              <div className='p-2 mt-1'>
                <div className='flex justify-between text-xs'>
                  <div class="flex items-center border border-gray-400 px-3 py-2 rounded-lg text-gray-700">
                    ...
                    <div class="w-px h-5 bg-gray-400 mx-3"></div>
                    <p class="text-sm font-medium">Call</p>
                  </div>
                  <div class="flex items-center border border-gray-400 px-3 py-2 rounded-lg text-gray-700">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-at-fill text-gray-500" viewBox="0 0 16 16">
                  ...
                  <div class="flex items-center border border-gray-400 px-3 py-2 rounded-lg text-gray-700">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar2-event text-orange-500" viewBox="0 0 16 16">
            ...
            <div className='flex justify-between'>
              <div>
                ...
                <div className='mt-2 flex gap-2'>
                  <div class="w-72 bg-gray-100 shadow-lg rounded-lg p-4">
                    <div class="flex items-center gap-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-telephone text-green-500" viewBox="0 0 16 16">
                        <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.6 17.6 0 0 0 4.168 6.608 17.6 17.6 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.68.68 0 0 0-.58-.122l-2.19.547a1.75 1.75 0 0 1-1.657-.459L5.482 8.062a1.75 1.75 0 0 1-.46-1.657l.548-2.19a.68.68 0 0 0-.122-.58z" />
                      </svg>
                      <p class="text-gray-700 font-medium">Share Catalog</p>
                    </div>
                  ...
                  <div class="w-72 bg-gray-100 shadow-lg rounded-lg p-4">
                    <div class="flex items-center gap-2">
                      ...
                      <p class="text-gray-700 font-medium">Introductor Call</p>
                    </div>
